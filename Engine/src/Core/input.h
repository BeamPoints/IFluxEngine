...
//Keyboard Input
FAPI b8 input_is_key_down(keys key);
FAPI b8 input_is_key_up(keys key);
FAPI b8 input_was_key_down(keys key);
FAPI b8 input_was_key_up(keys key);

void input_process_key(keys key, b8 pressed);

//Mouse Input
FAPI b8 input_is_button_down(buttons button);
FAPI b8 input_is_button_up(buttons button);
FAPI b8 input_was_button_down(buttons button);
FAPI b8 input_was_button_up(buttons button);
FAPI void input_get_mouse_postion(i32* x, i32* y);
FAPI void input_get_previus_mouse_position(i32* x, i32* y);
